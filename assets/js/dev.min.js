function loadJS(A, e, t) {
  var o = !!window.ActiveXObject,
    ...
    r = i ? document.documentElement : document.getElementsByTagName("head")[0];
  (a.type = "text/javascript"),
    (a.async = !0),
    a.readyState
      ? (a.onreadystatechange = function () {
          ("loaded" != a.readyState && "complete" != a.readyState) ||
            ((a.onreadystatechange = null), e && e());
        })
      : (a.onload = function () {
          e && e();
        }),
...
var duoshuoQuery = { short_name: "luolei" },
  GlobalConfigue = { masterDomain: "https://luolei.org" },
  General = {
    isMobile: !1,
    isWechat: !1,
    ...
    init: function () {
      ...
      "micromessenger" == e.match(/MicroMessenger/i) &&
        ((General.isWechat = !0), $("body").addClass("wechat-webview")),
        t && (General.isMobile = !0),
        $("body").hasClass("post-template") &&
          (General.updateImageWidth(), General.rewardLoader()),
    ...
    webFontLoader: function () {
      (WebFontConfig = {
        ...
        loadJS(General.absUrl + "/assets/js/webfont.js", function () {
          WebFont.load({ custom: { families: ["Exo", "iconfont"] } });
        });
    },
    arrowEvent: function () {
    ...
    scrollToPos: function (A) {
      ...
      $(window).scroll(function () {
        ...
        t.click(function (A) {
          A.preventDefault(),
            $("html,body").animate({ scrollTop: 0 }, 666, function () {
              window.location.hash = "#";
            });
        });
    },
      ...
      General.isWechat && $(".wechat-code b").html("长按上方二维码打赏作者"),
        ...
        $(".money-like .reward-button").click(function () {
          $(this).hasClass("active")
            ? ($(this).find("img.wechat-img").attr("src", A.wechat),
              $(this).find("img.alipay-img").attr("src", A.alipay),
              $(".money-code").fadeOut(),
              $(this).removeClass("active"))
            : ($(".money-code").fadeIn(), $(this).addClass("active"));
        });
    },
    commentLoader: function () {
      if (!$("body").hasClass("post-template")) return !1;
      var A = GlobalConfigue.masterDomain + location.pathname;
      $(window).scroll(function () {
        if (
          ...
          (t.src = "https://luoleiorg.disqus.com/embed.js"),
            ...
            loadJS("https://luoleiorg.disqus.com/embed.js", function () {
              $(".author-image").addClass("comment-loaded"),
                DISQUS.reset({
                  reload: !0,
                  config: function () {
                    (this.page.identifier = A), (this.page.url = A);
                  },
                });
            });
        }
...
$(document).ready(function () {
  ...
  ($.fn.lazyload = function (e) {
    ...
    return (
      ...
      this.each(function () {
        var A = this,
          e = $(A);
        (A.loaded = !1),
          (void 0 !== e.attr("src") && e.attr("src") !== !1) ||
            (e.is("img") &&
              (e.attr("src", a.placeholder), e.addClass("loading"))),
          e.one("appear", function () {
            if (!this.loaded) {
              ...
              (o.indexOf("upaiyun") > -1 || o.indexOf("file.is26.com") > -1) &&
                (1 == a.advanced_load && (o += "!"),
                1 == a.is_scale && (o += "/fw/" + a.scale_width),
                1 == a.webP_load && (o += "/format/webp")),
                $("<img />")
                  .bind("load", function () {
                    e.hide(),
                      e.is("img")
    ...
    ($.belowthefold = function (e, t) {
      ...
      return (
        (o =
          void 0 === t.container || t.container === window
            ? (window.innerHeight ? window.innerHeight : A.height()) +
              A.scrollTop()
            : $(t.container).offset().top + $(t.container).height()),
    ...
    ($.rightoffold = function (e, t) {
      ...
      return (
        (o =
          void 0 === t.container || t.container === window
            ? A.width() + A.scrollLeft()
            : $(t.container).offset().left + $(t.container).width()),
    ...
    $("body").hasClass("post-template") &&
      (General.addIcons(), General.commentLoader());
});
